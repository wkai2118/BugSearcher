...
public class MinimizeManager
{
	...
	public static void minisize()
	{
		...
		MinimizeManager.ItemShow.setEnabled(false);
	...
	{
		MainWindow.InitConfig.setProperty("editsize", "" + CodeEditTab.DefaultCodeEditSize);
		MainWindow.InitConfig.setProperty("theme", MainWindow.Theme);
		MainWindow.InitConfig.setProperty("encode", CodeEditTab.Encode);
		...
		if (GlobalGrammarWindow.GrammarSearch != null)
			GlobalGrammarWindow.GrammarSearch.dispose(); // 如果有查询窗没关，就关闭它
